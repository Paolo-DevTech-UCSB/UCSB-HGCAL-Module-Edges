...
angles = [0.250, 0.1250, 0.0625, 0.03125, 0.0156, 0.0078125, 0.0039, 0.00195, 0.000976, 0.0]
...
xoffs = np.linspace(-0.2, 0.2, 100)  # More points in the -1 to 1 range
yoffs = np.linspace(-0.2, 0.2, 100)  # More points in the -1 to 1 range
